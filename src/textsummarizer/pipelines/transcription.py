...
def transcribe_audio(audio_path: str) -> str:
    """
    Transcribes the given audio file using OpenAI's Whisper model via Hugging Face Serverless Inference API.
    """
    ...
    logger.info(f"Transcribing audio file via HF Inference API: {audio_path}...")
